    ...
    >
      ...
      <div className="email-card-header">
        ...
        <div className="email-badges">
          ...
          {/* SLA deadline badge */}
          {email.sla_deadline_steps && !isResolved && (
            <span style={{
              fontSize: 10, fontWeight: 700, padding: '2px 6px', borderRadius: 4,
              background: 'rgba(239,68,68,0.18)', color: '#ef4444',
              border: '1px solid rgba(239,68,68,0.35)', letterSpacing: '0.03em',
            }}>
              ⏱ SLA:{email.sla_deadline_steps}
            </span>
          )}
          {/* Thread follow-up badge */}
          {email.thread_position > 1 && !isResolved && (
            <span style={{
              fontSize: 10, fontWeight: 700, padding: '2px 6px', borderRadius: 4,
              background: 'rgba(139,92,246,0.18)', color: '#a78bfa',
              border: '1px solid rgba(139,92,246,0.35)', letterSpacing: '0.03em',
            }}>
              🔗 Thread #{email.thread_position}
            </span>
          )}
